...
const NAV_ITEMS = [
  { key: 'dashboard', icon: '\u{1F4C5}', label: '대시보드' },
  { key: 'members', icon: '\u{1F465}', label: '멤버 관리' },
  { key: 'shops', icon: '\u{1F37A}', label: '메뉴 관리' },
  { key: 'history', icon: '\u{1F4CB}', label: '주문 내역' },
  { key: 'summary', icon: '\u{1F4CA}', label: '월별 요약' },
];
